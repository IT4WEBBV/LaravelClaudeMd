...
foreach (['triggers.php', 'pipeline.php', 'manifest.php', 'checks.php', 'board.php', 'proof.php', 'proof_render.php', 'design_size.php', 'suite.php', 'dispatch.php', 'brief.php', 'run_cost.php', 'kickoff.php'] as $f) {
    $path = __DIR__ . '/../' . $f;
    if (is_file($path)) {
        require_once $path;
    }
